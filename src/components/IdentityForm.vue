        ...
        <PanelComponent header="Bridgit Calculator">
            <form @submit.prevent="onSubmit">
                ...
                <InputText 
                    ...
                    />
                    <small v-if="v$.firstName.$error" class="p-error" id="text-error">{{ v$.firstName.$errors[0].$message }}</small>
                </div>
                ...
                <InputText 
                    ...
                    />
                    <small v-if="v$.lastName.$error" class="p-error" id="text-error">{{ v$.lastName.$errors[0].$message }}</small>
                </div>
                ...
                <InputText 
                    ...
                    />
                    <small v-if="v$.location.$error" class="p-error" id="text-error">{{ v$.location.$errors[0].$message }}</small>
                </div>
                ...
                <InputMask 
                    ...
                    />
                    <small v-if="v$.dateOfBirth.$error" class="p-error" id="text-error">{{ v$.dateOfBirth.$errors[0].$message }}</small>
                </div>
                ...
                <div class="input-group">
                    ...
                    <FileUpload 
                        ...
                        />
                    <small v-if="v$.license.$error" class="p-error" id="text-error">Upload a valid drivers license image</small>
